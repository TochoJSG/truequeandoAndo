const productosJson2 = [
    ...
    {name: "Auto BMW", imgMain:"publicaciones/art12.jpg", intereses: "acepta{maquinas de vending,maquinas de fabricacion}", desc: "bmw 2000 blindado unico dueño",propietario:"Usuario B",condicion:"seminuevo"},
...
const carruselB = document.getElementById('carrusel-gral-second');	
let plantilla2='';
productosJson2.forEach(item=>{
	plantilla2+=`
	<div class="prod_car">
		<picture>
			<div class="imgBx">
...
carruselB.innerHTML = plantilla2;
